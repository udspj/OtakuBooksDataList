...
<div class="row">
	...
	<div v-on:click="getImgUrl()" style="width: 182px; height: 182px; background-color: #fff; margin:0 auto; position: relative; border-color: #cfcfcf; border-style: solid; border-width: 1px;">
		<img v-bind:src="'./static/thumbnails/'+good.id+'.jpg'" style="position: absolute; margin: auto; top: 0; left: 0; right: 0; bottom: 0;"></img>
	</div>
		<br />
		<a v-on:click="getImgUrl()" >{{ good.title }}</a>
		<br />
